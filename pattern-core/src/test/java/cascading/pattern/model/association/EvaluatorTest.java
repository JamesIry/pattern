...
public class EvaluatorTest
  ...
  Set<Output<String>> outputs = new HashSet<Output<String>>( Arrays.asList( output1, output2, output3 ) );
  ...
  public void testEvaluate()
    {
    AssociationRulesEvaluator<String, String> evaluator = new AssociationRulesEvaluator<String, String>( rules,
        new Outputs<String>( outputs ) );

    Map<String, Object> results = evaluator.evaluate( set1 );
